...
class ProductDao
{
    public static function getDetailByCateId($cateId, $pageNo = 1, $pageSize = 10)
    {
        ...
        $sql = 'SELECT si.id, si.name, si.cate_id AS cateId, si.product_id AS productId, '.
                      'si.slogan, si.price, si.amount, si.discount, si.sell_type AS sellType, si.btime, si.etime, ' .
