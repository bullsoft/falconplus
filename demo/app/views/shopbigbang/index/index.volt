    ...
    <div class="col-sm-4 col-lg-4 col-md-4">
        <div class="thumbnail">
            ...
            <div class="caption">
                ...
                <h4><a href="#">{{ __invoke__('Volt::output', "aaa,,", "bbb") }}</a></h4>
                <p>
                    <span style="font-weight: 800">{{ __invoke__('Volt::test1') }}</span>
                    This is a short description. Lorem ipsum dolor sit amet, consectetur adipiscing elit.{{ __invoke__('Volt::test', [1, 2]) }}
                </p>
            </div>
            <div class="ratings">
